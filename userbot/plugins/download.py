...
CMD_HELP.update({
    "download": [
        ...
        " - `.upload <link>`: Upload a locally(where @Sensible_userbot runs) stored file to Telegram.\n"
        " - `.drive <filename>`: Upload a locally(where @Sensible_userbot runs) stored file to GDrive.\n"
